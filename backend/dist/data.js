...
exports.dashboardSeed = exports.bankMovements = exports.salesInvoices = exports.expenseInvoices = exports.providers = void 0;
exports.money = money;
exports.filterByRange = filterByRange;
exports.sumAmounts = sumAmounts;
exports.buildAccountingSummary = buildAccountingSummary;
exports.buildAIInsight = buildAIInsight;
exports.providers = [
    {
        id: 'prov-1',
...
function buildAccountingSummary(range) {
    const sales = filterByRange(exports.salesInvoices, range);
    const expenses = filterByRange(exports.expenseInvoices, range);
...
function buildAIInsight(range) {
    ...
    const cashStatus = exports.dashboardSeed.bankBalance > summary.expenseTotal ? 'liquidez saludable' : 'revisar caja';
    return {
        title: `Lectura automatica para ${range}`,
        status: marginStatus,
        message: summary.margin >= 20
