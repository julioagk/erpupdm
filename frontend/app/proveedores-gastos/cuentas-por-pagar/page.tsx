...
const expenseCategories = [
  'Servicios y Materiales Indirectos', 'Mensajería', 'Gastos de Administración',
  'Honorarios Administrativos', 'Arrendamiento de Inmuebles', 'Viáticos y Gastos de Viaje',
  'Gastos de Oficina', 'Combustibles y Lubricantes', 'Otros Impuestos y Derechos',
  'Suscripciones y Cuotas', 'Comisiones Bancarias', 'Partidas No Deducibles'
];
...
export default function CuentasPorPagarPage() {
    ...
    try {
      const created = await fetchFromApi('/api/invoices', {
        ...
        body: JSON.stringify({
          ...
          category: newExpense.category, source: 'Cuenta por Pagar', status: 'pendiente',
  ...
  if (loading) return (
    <WorkspaceShell active="/proveedores-gastos/cuentas-por-pagar" eyebrow="Compras" title="Cuentas por Pagar" subtitle="Cargando...">
  ...
  return (
    <WorkspaceShell active="/proveedores-gastos/cuentas-por-pagar" eyebrow="Compras" title="Cuentas por Pagar" subtitle="Facturas pendientes de pago. Confirma el pago para registrar el egreso en banco.">
